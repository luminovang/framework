...
final class Math
{
    ...
    */
     ...
     * @example - Example:
     * ```php
     * Math::isLatLng('12.971603', '77.594605');              // true
     * Math::isLatLng('12.9716032', '77.5946052', true);      // true
     * Math::isLatLng('12.97160321', '77.59460521', true, 6); // false (too many decimals)
     * ```
     */
