...
final class Encoder
{
    ...
    */
    ...
    public static function encode(string $content, ?string $encoding = null): array
    {
        ...
        return [false, $content, strlen($content)];
    }
     ...
     * @param bool $encode Optional. Determines whether to return an encoding 
     *              or decoding function (default: true `encode`).
     *
     * @return string|null Returns the name of the appropriate PHP function for the encoding/decoding method, 
