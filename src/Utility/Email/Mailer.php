...
class Mailer implements LazyObjectInterface
{
    ...
    public static function getInstance(MailerInterface|string|null $interface = null): self
    {
        if (!self::$instance instanceof self) {
            self::$instance = new static($interface);
        }
    ...
    {
        return $this->attachment($path, $name, $encoding, $type, $disposition);
    }
