...
use \Luminova\Exceptions\{ErrorCode, RuntimeException, BadMethodCallException, InvalidArgumentException};
...
class Process
{
     ...
     * Process constructor.
     *
     * @param StreamInterface|Stream|Closure|resource|array|string $input Command string, callable, or stream to be executed.
    ...
    private function onError(
        string $message, 
        int $code = ErrorCode::PROCESS_ERROR
    ): void 
    {
