...
class Header implements LazyObjectInterface, Countable
{
    ...
    ): void 
    {
        ...
        $validateRequestHeaders ??= Luminova::isApiRequest();
    ...
    /**
     * Initializes and return request security configuration.
     * 
     * @return Security<Luminova\Base\Configuration> Return instance of application security configuration.
     */
    public static function getSecurityConfig(): Security
    {
        self::initRequestSecurityConfig();
    ...
    ): bool 
    {
        ...
        $headers['Access-Control-Allow-Credentials'] = self::$security->allowCredentials 
            ? 'true' 
            : 'false';
    ...
    private static function parseHeaders(array $headers, bool $withCharset = false, bool $isSend = true): array 
    {
        ...
        foreach ($headers as $header => $values) {
            ...
            foreach ($values as $value) {
                if($isSend && $header === 'Content-Type'){
                    $_SERVER['HTTP_LMV_SENT_CONTENT_TYPE'] = $value;
                }
