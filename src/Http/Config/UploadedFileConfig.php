<?php 
/**
 * Luminova Framework HTTP uploading a file config.
 *
 * @package Luminova
 ...
 */
namespace Luminova\Http\Config;

use Luminova\Http\File;
use Luminova\Interface\Arrayable;
use Luminova\Exceptions\RuntimeException;

class UploadedFileConfig implements Arrayable
{
    /**
    ...
    private static array $configurations = [
        ...
        'symlink'           => 'symlink',
        'base64_strict'     => 'base64StrictDecode',
        'data'              => 'data'
    ];
     ...
     * @param bool $base64StrictDecode Whether to enforce strict Base64 decoding for Base64-encoded uploads.
    ...
    public function __construct(
        ...
        public bool $base64StrictDecode = false,
