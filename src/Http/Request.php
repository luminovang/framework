...
final class Request implements RequestInterface, LazyObjectInterface, Stringable, Arrayable
{
     ...
     * 
     * @var Server<LazyObjectInterface> $server
     */
    public readonly LazyObjectInterface $server;

    /**
     * Header object providing HTTP request headers information.
     * 
     * @var Header<LazyObjectInterface> $header
     */
    public readonly LazyObjectInterface $header;

    /**
     * UserAgent object containing client browser details.
     * 
     * @var UserAgent<LazyObjectInterface> $agent
     */
    public readonly LazyObjectInterface $agent;
