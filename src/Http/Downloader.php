...
class Downloader
{
     ...
     *                                 (e.g. `'/protected/'`)
     *
     * @return self Returns downloader instance.
     * @see self::getAccelInternalPath()
     *
     * @example - Example:
     * ```php
     * use Luminova\Http\Downloader;
     ...
     * @param float|int $delay Delay between chunks in seconds (0 = no throttle).
     ...
     */
    protected function sendContents(int $chunkSize, float|int $delay, array $options): bool
    {
        [$isPartial, $offset, $length, $status] = $options;
     ...
     * @param float|int $delay Microseconds to sleep between chunks.
     ...
     *
     * @param SplFileObject $file Open resource or file object.
     * @param int $length Total bytes to read.
     * @param int $chunkSize Size of each read chunk.
     * @param float|int $delay Seconds delay between chunks.
     ...
     * @param float|int $delay Seconds to sleep between chunks.
     *
     * @return void
     */
