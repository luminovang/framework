...
trait RequestTrait
{
    ...
    ): Generator|UploadedFileInterface|null
    {
        ...
        return $this->createFileInstance($file, 0);
    }
     ...
     * @param int|null $isFlat Wether index for handling multiple file uploads for flat structure (default: false).
     * 
