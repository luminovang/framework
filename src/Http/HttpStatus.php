...
final class HttpStatus
{
     ...
     * 
     * @param mixed $code The HTTP status code to check.
     * 
    ...
    /**
     * Check if status code is in accepted range.
     *
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if client (299).
     */
    ...
    /**
     * Check if request was accepted for processing (202).
     * 
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if client (200).
     */
    public static function isAccepted(int $code): bool
    {
        return $code === 202;
    }
     ...
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if client (4xx) or server (599) error.
     */
    ...
    /**
     * Check if status code indicates a redirection (3xx).
     * 
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if client (3xx) or server (399) error.
     */
     ...
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if client (4xx) or server (199) error.
     */
     ...
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if client (5xx) or server (599) error.
     */
     ...
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if client (1xx) or server (199) error.
     */
    ...
    /**
     * Check if status code is for no-content.
     * 
     * Checks for: NO_CONTENT, RESET_CONTENT, NOT_MODIFIED.
     * 
     * @param int $code HTTP status code.
     * 
     * @return bool Return true if code matched.
     */
    public static function isNoContent(int $code): bool
    {
        return in_array(
            $code, 
            [self::NO_CONTENT, self::RESET_CONTENT, self::NOT_MODIFIED], 
            true
        );
    }
