<?php
/**
 * Luminova Framework storage system.
 *
 * @package Luminova
...
class Storage extends Adapters
{
     ...
     *
     * @return self Return a new instance of the `Storage` class.
     */
    ...
    public function url(string $file): ?string
    {
        ...
        try {
            ...
            StorageException::handleException($e->getMessage(), $e->getCode(), $e);
        }
     ...
     * @param array $options Optional file options.
     * 
    ...
    public function download(string $filename, ?string $name = null, bool $steam = false, array $headers = []): bool
    {
        try {
            ...
            $dl = new Downloader($this->read($filename, $steam), $name, $headers);
