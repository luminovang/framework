...
final class Factory 
{
     ...
     * 
     * The last parameter to pass to the factory constructor indicate 
     ...
     * @param string $factory The factory class name.
     * @param array $arguments Arguments to pass to the factory constructor.
     *                  - $shared The last parameter to pass to the factory constructor 
    ...
    */
    public static function register(): void 
    {
        try{
            ...
            $instance->queService($config->getServices());
    ...
    private static function create(string $class, ?string $alias = null, bool $shared = true, mixed ...$arguments): object
    {
        try {
            ...
            throw new RuntimeException(
                "Failed to instantiate factory class: '{$alias}', " . $e->getMessage(), 
                $e->getCode(), 
                $e
            );
        }
