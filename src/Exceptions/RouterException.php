    ...
    */
    ...
    private static function getErrorInformation(string $property): string 
    {
        ...
        return match($property){
            ...
            'invalid.controller' => 'Invalid class "%s". Must extend "Luminova\Base\BaseCommand", "Luminova\Base\BaseController", or implement "Luminova\Interface\RoutableInterface".',
