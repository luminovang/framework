...
{
    /**
     * Uploads a file to the server without using chunked file upload.
     *
    ...
    /**
     * Uploads a file to the server using stream file upload, allowing large files to be uploaded in chunck.
     *
     * @param string $path The directory path where the file will be stored.
     * @param array $file An associative array containing information about the uploaded file.
     ...
     * @return object<string, mixed> An object containing the upload status.
     */
    public static function stream(string $path, array $file, int $chunk = 0, int $chunks = 0, int $length = 4096): object
    {
        $response = [];
