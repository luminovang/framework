...
use \Luminova\Exceptions\{LuminovaException, AIException, RuntimeException, InvalidArgumentException};
 ...
 *
 * @method static Ollama<\Luminova\Base\AI> Ollama(?string $baseUrl = null, ?string $apiKey = null)
 * @method static OpenAI<\Luminova\Base\AI> OpenAI(?string $baseUrl = null, ?string $apiKey = null, ?string $organization = null, ?string $project = null)
 * @method static Anthropic<\Luminova\Base\AI> Anthropic(?string $baseUrl = null, ?string $apiKey = null, ?string $version = null, ?string $betaFeatures = null)
 * 
