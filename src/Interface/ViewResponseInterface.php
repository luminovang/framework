...
{
    /**
     * Get or create the singleton Response instance.
     *
     ...
     *
     * @return ViewResponseInterface Return shared instance of response class.
     * @throws ResponseException If content is not `null` and error occurs while processing.
     */
