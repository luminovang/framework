 ...
 *
 * @property-read Server<LazyObjectInterface>|null $server HTTP server properties.
 * @property-read Header<LazyObjectInterface>|null $header HTTP request headers.
 * @property-read UserAgent<LazyObjectInterface>|null $agent Client user-agent and browser info.
 */
