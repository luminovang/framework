...
use \Luminova\Interface\{LazyObjectInterface, PromiseInterface, DatabaseInterface, ExceptionInterface};
...
{  
    ...
    {
        if(!$this->cacheKey || !self::$cache instanceof Cache){
        ...
        return self::$cache->deleteItem($this->cacheKey, true);
    }
    ...
    ): self 
    {
        ...
        self::newCache($storage, $subfolder, $persistentId);
    ...
    */
     ...
     * @return void
     */
    private static function newCache(
        ?string $storage = null, 
        ?string $subfolder = null,
        ?string $persistentId = null
    ): void
