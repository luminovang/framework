...
/**
 * @method static RawExpression currentDate() Create a raw SQL expression for current date, using `CURDATE()`.
 * @method static RawExpression currentTime() Create a raw SQL expression for current time, using `CURTIME()`.
 * @method static RawExpression currentYear() Create a raw SQL expression for current year, using `YEAR(NOW())`.
 * @method static RawExpression currentMonth() Create a raw SQL expression for current month, using `MONTH(NOW())`.
 * @method static RawExpression currentDay() Create a raw SQL expression for current day, using `DAY(NOW())`.
 * @method static RawExpression currentHour() Create a raw SQL expression for current hour, using `HOUR(NOW())`.
 * @method static RawExpression currentMinute() Create a raw SQL expression for current minute, using `MINUTE(NOW())`.
 * @method static RawExpression currentSecond() Create a raw SQL expression for current seconds, using `SECOND(NOW())`.
 */
final class RawExpression implements Stringable, JsonSerializable
{
    ...
    public static function vector(array $embedding, bool $pgFormat = false): self
    {
        $literal = $pgFormat
            ? '[' . implode(',', $embedding) . ']'
            : json_encode($embedding, JSON_PRESERVE_ZERO_FRACTION);
