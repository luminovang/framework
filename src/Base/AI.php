...
abstract class AI implements LazyObjectInterface, AIClientInterface
{
     ...
     * Client API Base URL.
     *
     * @var string $url (e.g, `https://example.com/api/`)
     */
     ...
     * Base AI constructor.
     * 
     * @see self::resolveConstructorArgs() - To define dynamic constructor arguments.
     */
    ...
    protected function endpoint(string $name, string $suffix = ''): string
    {
        ...
        return $this->url . $this->endpoints[$name] . '/' . $suffix;
    }
     ...
     */
    protected function eHandler(Throwable $e): void
    {
