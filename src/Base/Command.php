 ...
 * @property Application<\Luminova\Foundation\Core\Application,LazyObjectInterface>|null $app @inheritDoc
 * 
...
abstract class Command extends Terminal implements RoutableInterface
{
     ...
     * 
     * @var Application<\Luminova\Foundation\Core\Application,LazyObjectInterface>|null $app
     */
