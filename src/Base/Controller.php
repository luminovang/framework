 ...
 * ```php
 * public function foo(): Luminova\Interface\ContentResponseInterface 
 * {
 *      return new Response(content: ['status' => 'OK'], 200);
 *      // Alternative example:
 ...
 * ```php
 * public function secure(): Luminova\Interface\ContentResponseInterface 
 * {
...
abstract class Controller implements RoutableInterface
{
    ...
    {
        $this->app     = Luminova::kernel('app', shared: true);
