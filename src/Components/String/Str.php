 ...
 * 
 * @mixin \Luminova\Components\Object\Prototypeable
 * 
 * @example - Usage:
 * ```php
...
class Str implements Stringable, ArrayAccess, PrototypeableInterface
{
     ...
     *
     * @param string $algo The hash algorithm (e.g., `xxh3`, `md5`, `sha256`).
     ...
     * ```
     */
    public function hash(string $algo = 'xxh3', bool $binary = false, array $options = []): self
    {
        $this->valueOf = Luminova::hash(
            $algo, 
            $this->valueOf, 
            $binary, 
            $options,
