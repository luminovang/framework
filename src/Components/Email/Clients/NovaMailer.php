...
{
    public final const CHARSET_UTF8 = 'UTF-8';
    public final const CONTENT_TYPE_PLAINTEXT = 'text/plain';
    public final const CONTENT_TYPE_TEXT_CALENDAR = 'text/calendar';
    public final const CONTENT_TYPE_TEXT_HTML = 'text/html';
    public final const CONTENT_TYPE_MULTIPART_ALTERNATIVE = 'multipart/alternative';
    public final const CONTENT_TYPE_MULTIPART_MIXED = 'multipart/mixed';
    public final const CONTENT_TYPE_MULTIPART_RELATED = 'multipart/related';

    public final const ENCODING_7BIT = '7bit';
    public final const ENCODING_8BIT = '8bit';
    public final const ENCODING_BASE64 = 'base64';
    public final const ENCODING_BINARY = 'binary';
    public final const ENCODING_QUOTED_PRINTABLE = 'quoted-printable';
    ...
    public function addAttachment(
        ...
        try {
            if (!Filesystem::isAccessible($path)) {
                MailerException::rethrow('file_access', $path);
            }
            ...
            if ($this->exceptions) {
                MailerException::rethrow($e->getMessage());
            }
    ...
    public function connection(array $options = []): mixed
    {
        ...
        Env::setExecutionTimeLimit($this->Timeout);
    ...
    {
        return Encoder::base64UrlEncode(hash(
            'sha256', 
            Random::generate(10, Random::TYPE_ALPHANUMERIC), 
            true
        ));
    }
    ...
    */
    ...
    private function sendAttachment(): array
    {
        ...
        foreach ($this->attachments as $attachment) {
            $fileContent = chunk_split(base64_encode(Filesystem::contents($attachment['path'])));
