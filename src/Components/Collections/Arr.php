...
use Luminova\Utility\Util;
use Luminova\Interface\Arrayable;
use Luminova\Components\String\{Str, Listifier};
...
class Arr implements ArrayAccess, IteratorAggregate, Countable, Arrayable, Stringable 
{
    /**
     ...
     *
     * @return self Returns a new instance of array object.
     */
     ...
     *
     * @return self Returns a new instance or the current instance depending on immutable mode.
     *
     * @internal This helper is used internally by most modifying methods.
     */
    protected function newArray(array $data): self
    {
        if ($this->immutable) {
     ...
     *
     * @return Str<Stringable>|string Returns a minified PHP array string.
     *         - Plain string value.
     *         - Stringable object wrapping the minified string if `$object` is true
     * 
     * @example - Examples:
     * ```php
     * $array = [
     ...
     * ```
     */
    public function minify(bool $object = false): Stringable|string
    {
        if ($this->array === []) {
            return $object ? Str::of('[]') : '[]';
        }

        $string = Util::minifyArray($this->array);
     ...
     * 
     * @return self Returns an array containing all the entries 
     *      from the current array that are not present in any of the other arrays.
     */
     ...
     *
     * @return self Return a new instance containing the sorted array.
     * @see immutable()
     *
     * @example - Examples:
     * ```php
     ...
     * 
     * @return self Returns a new instance containing array keys from the current array.
     */
     ...
     * 
     * @return self Returns a new instance containing array values from the current array.
     */
     ...
     *
     * @return self Returns a new instance containing only unique values.
     *
     * @example - Example:
     * ```php
     ...
     * 
     * @return self Returns a new instance containing the extracted column.
     */
     ...
     * 
     * @return self Returns a new instance containing the values corresponding to the specified property name.
     */
     ...
     * 
     * @return self Returns a new instance containing the filters.
     */
    public function filter(?callable $callback = null, int $mode = 0): self
    {
        return $this->newArray(array_filter(
            $this->array, 
            $callback, 
            $mode
        ));
     ...
     * 
     * @return self Returns a new instance containing the elements after applying callback.
     */
    public function map(callable $callback, mixed ...$arrays): self
    {
        return $this->newArray(array_map(
            $callback, 
            $this->array, 
            ...self::pack(...$arrays)
        ));
     ...
     * 
     * @return self Returns a new instance containing the reversed array.
     */
    public function reverse(bool $preserveKeys = false): self
    {
        return $this->newArray(array_reverse(
            $this->array, 
            $preserveKeys
        ));
    }
     ...
     * 
     * @return self Returns a new instance containing the chunked array.
     */
    public function chunk(int $size, bool $preserveKeys = false): self
    {
        return $this->newArray(array_chunk(
            $this->array, 
            $size,
            $preserveKeys
        ));
     ...
     *
     * @return self Returns a new instance containing the sliced portion of the array.
     */
    public function slice(int $offset, ?int $length = null, bool $preserveKeys = false): self
    {
        return $this->newArray(array_slice(
            $this->array, 
            $offset, 
            $length, 
            $preserveKeys
     ...
     *
     * @return self Returns the lowest item/value, or empty-array if no valid comparison can be made.
     */
    public function min(?string $key = null): self
    {
        return $this->newArray(array_min(
            $this->array, 
            $key
        ) ?? []);
    }
     ...
     * @param string|null $key Key used for comparison in structured arrays.
     *
     * @return self Returns the highest item/value, or empty-array if no valid comparison can be made.
     */
    public function max(?string $key = null): mixed
    {
        return $this->newArray(array_max(
            $this->array, 
            $key
        ) ?? []);
    }
