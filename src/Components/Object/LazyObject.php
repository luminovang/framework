...
use \Luminova\Exceptions\{LuminovaException, LogicException, RuntimeException};
...
class LazyObject implements LazyObjectInterface, Stringable, JsonSerializable
{
     ...
     *
     * @throws RuntimeException If instantiation fails or the initializer throws any non-LuminovaException error.
     * @throws LogicException If the initializer does not return an object.
     * @throws LuminovaException If the initializer callback explicitly throws an LuminovaException.
     */
    private function onHydrateLazyObject(?string $fn = null, ?string $assert = null, ?array $arguments = null): void
    {
        ...
        try {
            ...
            [$file, $line] = LuminovaException::trace(3);
