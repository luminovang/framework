...
trait Prototypeable
{
     ...
     * @var string
     */
    public static string $PROTO_PROPERTY = 'properties';
     ...
     * @var string
     */
    public static string $PROTO_METHOD = 'methods';
     ...
     * @example - Example:
     * ```php
     * use Luminova\Components\String\Str;
     * 
     * $str = new Str('Hello');
     * 
     ...
     * @template \T of object
     */
    public function getPrototype(string $prototype, string $of = 'methods'): mixed 
    {
    ...
    {
        return isset($this->_prototypes_[self::$PROTO_PROPERTY][$prototype]) || 
