...
final class Async
{
    ...
    /**
     * Creates an awaitable Future from a fiber or callable.
     *
     * Wraps the given task in a `Future` instance without executing it immediately.
     * The returned future can later be passed to `await()` for controlled execution
     * and result retrieval.
     *
     * @param Fiber|(callable():mixed) $task Task to execute asynchronously.
     *        Callables are automatically wrapped in a `Fiber`.
     *
