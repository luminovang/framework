    ...
    private static array $commands = [
       ...
       'auth' => [
        ...
        'project' => [
            'name'        => 'Project',
            'group'       => 'project',
            'description' => "Prepare the application for production by exporting, importing, or archiving project files into a build-ready structure.",
            'usages' => [
                'php novakit project',
            ],
            'options' => [
                '-e, --export'  => "Export production-ready project files to the build directory.",
                '-i, --import'  => "Import a project from a specified directory into the current project directory.",
                '-a, --archive' => "Archive production-ready project files into a ZIP file in the build directory.",
                '-d, --dir'     => "Specify the source directory path for importing project files.",
                '-p, --progress'=> "Display a progress indicator during the build process.",
            ...
            'examples' => [
                'php novakit project --archive'   => 'Package the application into a production ZIP archive.',
                'php novakit project --export'    => 'Export application files to the production build directory.',
                'php novakit project --import --dir=/path/to/project' => 'Import application files from another dir.',
                'php novakit project -a -vv'  => 'Create a ZIP archive with verbose output enabled.'
            ],
        ],
