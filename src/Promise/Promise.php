...
final class Promise implements PromiseInterface
{
     ...
     * @param (callable(mixed $input):void)|null $onResolved The callback to be executed 
     *      when the promise is resolved.
     * @param (callable(mixed $input):void)|null $onRejected The callback to be executed 
     *      when the promise is rejected.
     *
     * @return void
     */
