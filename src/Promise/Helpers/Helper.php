...
use \Luminova\Exceptions\{ErrorCode, LuminovaException, ErrorException, LogicException};
...
final class Helper 
{
     ...
     *
     * 
     * @return LuminovaException Return exception object.
     */
    private static function getRejectionHandler(mixed $error, string|int $code): LuminovaException 
    {
     ...
     * ```
     *
     * @param \ReflectionParameter[] $hints The callback's parameters to inspect.
