...
final class Rule
{
    ...
    /**
     * Static method proxy to build a validation rule definition.
     *
     ...
     * @param array{0:array,1:string} $argument Optional rule arguments (e.g. [5], ['a', 'b'])
     *
     * @return array{0:string,1:?array,2:string} Return an array that resolve to rule.
     * @throws InvalidArgumentException If invalid rule name.
     *
     * @example - Example:
     * ```php
     * Rule::in_array([6], 'Value must in array')
     * ```
     */
    public static function __callStatic(string $rule, array $argument): array
    {
        if(!self::isRule($rule)){
            throw new InvalidArgumentException(sprintf(
                'Invalid unsupported rule method name: %s.',
                $rule,
            ));
        }
        ...
        return [$rule, $values, $argument[1] ?? "The {field} is invalid ({$rule})."];
    }
    ...
    public static function isRule(string $name): bool 
    {
        return match ($name) {
            ...
            'default', 'fallback', 'nullable', 'name', 'nullbyte',
            'string', 'between', 'lat', 'latitude', 'contains',
     ...
     *
     * @return array{0:string,1:null,2:string} Return an array that resolve to rule.
     */
    ...
    /**
     * Validate whether the value allows or rejects null bytes.
     * 
     * Rule name: `nullbyte`
     *
     * Fails when the validation mode does not match the presence
     * of null byte characters (`\0`) in the value.
     *
     * - When `$allow` is `false`, validation fails if the value contains null bytes.
     * - When `$allow` is `true`, validation fails if the value does not contain null bytes.
     *
     * @param bool $allow Whether null bytes should be allowed or required (default: false).
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:bool},2:string} Return an array that resolve to rule.
     */
    public static function nullbyte(bool $allow = false, ?string $error = null): array 
    {
        $error ??= ($allow
            ? 'The {field} must contain null bytes.'
            : 'The {field} does not allow null bytes.'
        );

        return ['nullbyte', [$allow], $error];
    }
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:string},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:array,1:bool},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:bool,1:int,2:int},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:bool,1:bool},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:float|int},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:float|int,1:float|int},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:int},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:bool,1:int},2:string} Return an array that resolve to rule.
     */
     ...
     * Rule name: `longitude`
     *
     * Accepts values in the range −180 to +180. Delegates to `Validator::isLng()`.
     *
     * @param bool $strict Whether to enable strict format checking (default `false`).
     * @param int $precision Maximum number of decimal digits to allow (default `6`).
     * @param string|null $error Optional error message if validation failed.
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:int,1:int},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:mixed},2:string} Return an array that resolve to rule.
     */
    ...
    /**
     * Require that the value contains (or does not contain) a given substring.
     *
     * Rule name: `contains`
     *
     * This rule checks whether the given `$needle` exists inside the value.
     * It does NOT use regular expressions.
     *
     * - When `$allow` is `false`, validation fails if the needle is NOT found.
     * - When `$allow` is `true`, validation fails if the needle IS found.
     *
     * @param string $needle Substring to search for.
     * @param bool $allow If true, rejects values containing the needle (default: `false`).
     * @param string|null $error Optional custom error message.
     *
     * @return array{0:string,1:array{0:string,1:bool},2:string} Rule definition.
     */
    ...
    ): array 
    {
        $error ??= (
            $allow
                ? 'The {field} must not contain the given value.'
                : 'The {field} must contain the given value.'
        );

        return ['contains', [$needle, $allow], $error];
    }
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:array},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:bool,1:array},2:string} Return an array that resolve to rule.
     */
     ...
     * @param string|null $error Optional error message if validation failed.
     *
     * @return array{0:string,1:array{0:callable},2:string} Return an array that resolve to rule.
     */
