 ...
 *
 * @return \Luminova\AI\Client\OpenAI|\Luminova\AI\Client\Anthropic|\Luminova\AI\Client\Ollama|AIClientInterface|array 
 *          Returns the response array when `$prompt` is provided, otherwise returns the configured AI client instance.
