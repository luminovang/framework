...
function __show_html_debug_tracer(array $trace, ?array $timelines = null): void{
?>
            ...
            <div class="content" id="memory">
                ...
                <table>
                    <tbody>
                        ...
                        <?php if(defined('APP_BOOTED') && ($dbTime = shared('__DB_QUERY_EXECUTION_TIME__', default: 0)) > 0): ?>
                        <tr>
